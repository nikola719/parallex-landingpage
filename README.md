# Frontend Mentor - Landing page with parallax animation and 7-1 modular scss structure

![Design preview for the Profile card component coding challenge](./images/design.jpg)
...
Code mobile-first.
● Use a modular 7-1 Sass pattern.
● Please do not use Bootstrap, Foundation or similar frameworks.
● Please add a “lazy loading“ effect to the text and parallax animation to the images —
where you think it works well to enhance the design.
